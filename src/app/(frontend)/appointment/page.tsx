        ...
        <div className="relative flex min-h-[480px] w-full flex-col justify-center items-center">
          ...
          <div className="relative z-10 flex w-full flex-col justify-center items-center px-4 py-4 md:px-10 lg:px-15 xl:px-20 md:py-10">
            <div className="mx-auto w-full max-w-[1200px]">
              <h1 className="mx-auto text-4xl font-semibold text-center leading-[1.125] text-white md:text-5xl lg:text-6xl xl:text-[64px] xl:leading-[1.125]">
                <span className="text-secondary">Schedule</span> Your Auto Repair{' '}
                <span className="text-secondary">Appointment Today!</span>
              </h1>
              <p className="text-white/50 justify-center text-center">
