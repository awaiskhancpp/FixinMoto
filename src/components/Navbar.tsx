...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`fixed px-6 md:px-20 z-[900] w-full ${scrolled ? ' bg-white text-black' : 'bg-transparent text-white'}`}
      >
        <div className="mx-auto w-full max-w-[1440px] grid grid-cols-3 items-center pt-6 pb-3">
