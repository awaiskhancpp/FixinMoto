...
export default function CallToAction() {
  return (
    <>
      <section className="w-full relative flex flex-col  bg-gradient-to-b from-gray-600 pt-20 to-[#292929]">
        <div className="mx-auto max-w-[1440px]">
          <div className="relative z-10 flex flex-col sm:py-20 py-10 pl-2 sm:pl-30 justify-center text-white">
            <h2 className="lg:text-7xl text-4xl">
              ...
              <br />
              in <span className="text-secondary">Top Shape!</span>
            </h2>
            <p className="text-gray-300 pt-4">
              Ready to give your car the care it deserves?
              <br /> Contact FixinMoto for a free consultation or to book a service appointment
              today
            </p>
          </div>
          <div>
